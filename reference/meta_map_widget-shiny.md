...
``` r
meta_map_widgetOutput(outputId, width = "100%", height = "400px")

renderMeta_map_widget(expr, env = parent.frame(), quoted = FALSE)
```
...
- expr:
  ...
  An expression that generates a meta_map_widget
